...
aria2c --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=true \
       ...
       --rpc-max-request-size=1024M --max-connection-per-server=10 --max-concurrent-downloads=15 --split=10 \
       ...
       --http-accept-gzip=true --max-file-not-found=0 --max-tries=25  --peer-id-prefix=-qB4520- --reuse-uri=true \
